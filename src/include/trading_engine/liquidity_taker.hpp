...
class LiquidityTaker {
   public:
    ...
    LiquidityTaker(common::Logger *logger, TradeEngine *trade_engine, const FeatureEngine *feature_engine,
        ...
        // };
        // trade_engine->algoOnTradeUpdate_ = [this](auto market_update, auto book) { onTradeUpdate(market_update,
        // book); }; trade_engine->algoOnOrderUpdate_ = [this](auto client_response) { onOrderUpdate(client_response);
        // };
    }
